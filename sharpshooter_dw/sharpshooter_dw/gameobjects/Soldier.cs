...
namespace sharpshooter_dw
{
    public class Soldier
    {
        ...
        public void Move()
        {
            //TASK1: Determine forward velocity from current angle.

            this.velocity.X = (float)Math.Cos(facingAngle*Math.PI/180)*movespeed*walkdirc;
            this.velocity.Y = (float)-Math.Sin(facingAngle*Math.PI/180)*movespeed*walkdirc;
